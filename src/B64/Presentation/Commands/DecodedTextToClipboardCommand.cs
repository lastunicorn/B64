...
{
    internal class DecodedTextToClipboardCommand : ICommand
    {
        private readonly ApplicationState applicationState;

        public event EventHandler CanExecuteChanged;

        public DecodedTextToClipboardCommand(ApplicationState applicationState)
        {
        ...
        {
            Clipboard.SetText(applicationState.DecodedText);
        }
