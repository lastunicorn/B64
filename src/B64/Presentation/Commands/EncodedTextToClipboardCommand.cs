...
{
    internal class EncodedTextToClipboardCommand : ICommand
    {
        private readonly ApplicationState applicationState;

        public event EventHandler CanExecuteChanged;

        public EncodedTextToClipboardCommand(ApplicationState applicationState)
        {
        ...
        {
            Clipboard.SetText(applicationState.EncodedText);
        }
